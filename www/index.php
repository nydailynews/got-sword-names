...
<main>
    <article>
        ...
        <div class="button-box">
            ...
            <button id="save-weapon" onClick="save_weapon();">Save</button>
            <button id="share-weapon" onClick="share_weapon();">Share</button>
        </div>
...
function generate_weapon() {
    if ( count == 0 ) $('#weapon-image').removeClass('initial');
    count += 1;
    if ( count < 35 ) {
        if ( count % 10 == 0 ) {
            ad += 1;
